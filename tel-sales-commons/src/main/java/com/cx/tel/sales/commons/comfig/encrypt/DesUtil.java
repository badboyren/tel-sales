...
public class DesUtil {
    ...
    public static void main(String[] args) {
        System.out.println("url::"+encrypt("jdbc:mysql://localhost:3306/dev-sales?useSSL=false&useUnicode=true&characterEncoding=utf-8",KEY));
        System.out.println("username::"+encrypt("root",KEY));
        System.out.println("password::"+encrypt("mysql",KEY));
    }
}
